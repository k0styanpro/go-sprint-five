...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*w.Weight + (math.Pow(w.meanSpeed()*KmHInMsec, 2)/(w.Height/CmInM))*CaloriesMeanSpeedMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
